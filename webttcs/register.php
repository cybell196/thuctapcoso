<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $repassword = testInput($_POST['repassword']);
        ...
        if($password === $repassword){
            if(mysqli_num_rows($result_check) == 1){
                ...
                $sql = " INSERT INTO account (id, username, password, email)
            ...
            $errorRegister = "Mật khẩu chưa khớp!";
        }
    } 
?>
...
<!-- css -->
    ...
    <body>
        ...
        <!-- Modal Search End -->
            ...
            <!-- register -->
        <div class="container-fluid my-5 py-5 login-register">
            <div id="register" class="container my-5 py-5">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-8 col-10 rounded-1 shadow bg-light">
                        
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                            <h2 class="text-center m-5">Đăng ký</h2>
                            <h4 class="text-red"><?php echo $errorRegister . $registerSuccess?></h4>
                            ...
                            <div class="input-login justify-content-center w-95 mb-4 mx-2 border-bottom">
                                <div class="row">
                                    <div class="col-1">
                                        <span class="fw-bold text-dark text-end me-2"><i class="bi bi-envelope-fill"></i></span>
                                    </div>
                                    <div class="col-11">
                                        <input class="w-100 p-1 input-no-focus border-0" type="email" name="email" placeholder="Email" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-login justify-content-center w-95 mb-4 mx-2 border-bottom">
                                <div class="row">
                                    <div class="col-1">
                                        <span class="fw-bold text-dark text-end me-2"><i class="bi bi-key"></i></span>
                                    </div>
                                    <div class="col-11">
                            ...
                            <div class="input-login justify-content-center w-95 mb-4 mx-2 border-bottom">
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <input class="w-95 p-1 input-no-focus border-0" type="password" name="repassword" placeholder="Nhập lại mật khẩu" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <button type="submit" name="register" class="btn text-light bg-primary w-70 mb-2">
                                    Đăng ký
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="login-end">
                            <div class="row mb-4">
                                <p class="fs-6 mt-2 text-center">Đã có tài khoản? <a href="login.php" id="login-btn">Đăng nhập</a> ngay</p>
                            </div>
                        </div>
                        </div>
                    </div>
