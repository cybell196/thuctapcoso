        ...
        <div class="container pt-5 mt-5">
            <div class="row">
                <div class="col-8 mx-auto">
                    <h1 class="text-center mb-4">Xin chào <?php echo $_SESSION['loginSession'] ?></h1>
                    
                    <div class="row mr-auto">
                        <div class="col d-inline">
                            <div class="text-end lead ">
                            <a href="change-pass.php" id="btn-changePass">
                        ...
                        <form id="info" class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="address" value="123 Đường ABC, Quận 1, TP.HCM" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" value="nva@example.com" disabled>
                            </div>

                            <button type="submit" class="btn btn-primary mt-2" data-toggle="tooltip" data-placement="right" title="Không thể sửa thông tin bây giờ" disabled>Chỉnh sửa</button>
